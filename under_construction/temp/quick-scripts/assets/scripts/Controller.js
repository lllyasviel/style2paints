...
cc._RF.push(module, 'a2f315Lr3BIGZGXpazlQtl/', 'Controller', __filename);
...
cc.Class({
    ...
    onColorizeClicked: function onColorizeClicked() {
        ...
        xhr.send("sketch=" + encodeURIComponent(sketchDataURL) + "&reference=" + encodeURIComponent(referenceDataURL) + "&hint=" + encodeURIComponent(hintDataURL) + "&version=" + version.toString() + "&denoise=" + denoiseV.toString() + "&sketchID=" + sketchID + "&referenceID=" + referenceID);
        spBTN.enabled = false;
        resultTexture = null;
